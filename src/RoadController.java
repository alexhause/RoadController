...
public class RoadController {
    ...
    private static int controllerMaxHeight = 4000; // mm переменная
    ...
    public static void main(String[] args) {
        ...
        Scanner scanner = new Scanner(System.in); // переменная ссылочного типа
        int carsCount = scanner.nextInt(); // переменная

        for (int i = 0; i < carsCount; i++) {
            Car car = Camera.getNextCar(); // переменная ссылочного типа
